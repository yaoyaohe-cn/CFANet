...
parser = argparse.ArgumentParser(description='CFANet & other models for Time Series Forecasting')

# basic config
parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
parser.add_argument('--model', type=str, required=True, default='CFANet', help='model name')
...
parser.add_argument('--alpha', type=float, default=0.1, help='scaling factor')
